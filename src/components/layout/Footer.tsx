...
const getSocialIcon = (platform: string): ReactNode => {
  const iconProps: IconProps = { className: 'w-5 h-5 group-hover:scale-110 transition-transform duration-200' };
